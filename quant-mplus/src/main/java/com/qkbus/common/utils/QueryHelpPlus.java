...
package com.qkbus.common.utils;
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                if (q != null) {
                    ...
                    //多字段查询
                    String equalBlurry = q.equalBlurry();
                    ...
                    // 多字段
                    if (ObjectUtil.isNotEmpty(equalBlurry)) {
                        String[] uid = equalBlurry.split(",");
                        //queryWrapper.or();
                        queryWrapper.and(wrapper -> {
                            for (int i = 0; i < uid.length; i++) {
                                String column = humpToUnderline(uid[i]);
                                //if(i!=0){
                                wrapper.or();
                                //}
                                wrapper.like(column, val.toString());
