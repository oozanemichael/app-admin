package com.qkbus.modules.config.service.impl;
...
import com.qkbus.modules.config.service.mapper.AppConfigMapper;
...
public class AppConfigServiceImpl extends BaseServiceImpl<AppConfigMapper, AppConfig> implements AppConfigService {
    ...
    private void cacheConfig() {
        // 初始化系统全局配置信息
        List<AppConfig> appConfigs = baseMapper.quantConfigs();
