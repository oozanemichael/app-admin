...
public class RoleController {
    ...
    public void download(HttpServletResponse response, RoleQueryCriteria criteria) throws IOException {
        ...
        criteria.setLevel(currentLevel);
    ...
    public ResponseEntity<List<Role>> getAll(RoleQueryCriteria criteria, @PageableDefault(value = 2000, sort = {"level"}, direction = Sort.Direction.ASC) Pageable pageable) {
