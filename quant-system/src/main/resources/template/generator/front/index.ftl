    ...
    <div class="app-container">
        ...
        <div class="head-container">
                    ...
                    <#if betweens??>
                        <#list betweens as column>
                            ...
                            <#--                 <el-date-picker
                                      ...
                                      &lt;#&ndash;               start-placeholder="${column.changeColumnName}Start"
                                                     end-placeholder="${column.changeColumnName}End"&ndash;&gt;
            ...
            <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0"
                ...
                <el-form ref="form" :model="form"  :inline="true"    <#if isNotNullColumns??>:rules="rules"</#if> size="small"
                         label-width="80px">
                    <#if columns??>
